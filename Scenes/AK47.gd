...
onready var flash = preload("res://Scenes/MuzzelFlash.tscn")
...
func _process(delta):
	if Input.is_action_pressed("shoot") and can_shoot and PlayerStats.ammo_AK47 > 0:
		gun_sprite.play("shoot")
		make_flash()
		check_hit()
		PlayerStats.change_AK47_ammo(-1)
		can_shoot = false
